export const translations = {
  eng: {
    ...
    passwordInvalidCriteria: 'Password must have: at least ',
    passwordInvalidCriteriaLength: '8 characters long',
    passwordInvalidCriteriaLowercase: 'one lowercase letter',
    passwordInvalidCriteriaNumber: 'one number',
    passwordInvalidCriteriaSpecial: 'one special character',
  ...
  rus: {
    ...
    passwordInvalidCriteria: 'Пароль должен иметь: хотя бы ',
    passwordInvalidCriteriaLength: '8 символов',
    passwordInvalidCriteriaLowercase: 'одну строчную букву',
    passwordInvalidCriteriaNumber: 'одну цифру',
    passwordInvalidCriteriaSpecial: 'один спецсимвол',
  ...
  ukr: {
    ...
    passwordInvalidCriteria: 'Пароль повинен мати: хоча б ',
    passwordInvalidCriteriaLength: '8 символів',
    passwordInvalidCriteriaLowercase: 'одну малу літеру',
    passwordInvalidCriteriaNumber: 'одну цифру',
    passwordInvalidCriteriaSpecial: 'один спецсимвол',
